<?php
    ...
    class DAOProducto
    {
        ...
        public static function getPaginaProducto(int $numPag, int $tamPag = 10) : array
        {
            ...
            while (($prod = $resultado -> fetch(PDO::FETCH_ASSOC)) != null) {
        ...
        public static function numProductos() : int
        {
            ...
            return intval($resultado -> fetch(PDO::FETCH_ASSOC)['numProds']);
        }
        ...
        public static function maxNumProducto() : int
        {
            ...
            return intval($resultado -> fetch(PDO::FETCH_ASSOC)['max']);
        }
